...
class MakananAdapter(val itemList:ArrayList<ModelMakanan>,
    ...
    class MyViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView){
        ...
        init {
            ...
            itemdesk = itemView.findViewById(R.id.deskripsi) as TextView
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.itemdesk.setText(itemList[position].deskripsi)
        ...
        holder.itemView.setOnClickListener (){
            ...
            //putextra
            intent.putExtra("txtimg", itemList[position].image)
            intent.putExtra("judul", itemList[position].judul)
            intent.putExtra("desk", itemList[position].deskripsi)
